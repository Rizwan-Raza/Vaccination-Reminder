 ...
 */
@WebServlet("/GetTodaysNoti")
public class GetTodaysNoti extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetTodaysNoti() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<TodayNot> ch = child.getTodaysNoti();
		...
		for (TodayNot todayNot : ch) {
			...
			out.println("\"vid\":\"" + todayNot.getVaccine().getvId() + "\"");
			out.println("}");
			first = false;
		}
		out.println("]}");
